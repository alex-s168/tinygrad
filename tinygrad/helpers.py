...
def _reconstruct_cell(val):
  return next(iter((lambda: val).__closure__ or tuple()))
def _serialize_cell(cell:types.CellType):
  return (_reconstruct_cell, (cell.cell_contents,))
